...
class odbc_db 
{
   ...
   public:
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////
      void update(string table, string column, string value, string scope);
      
      string stringSnip(string str);

      void sendUpdate(string command);

      string getNewQuantity(string currentQ, string used, string operation);

      void updateCollectionQuantity(string id, string name, string set, string used);
